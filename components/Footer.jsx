                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/jobs" className="text-slate-400 hover:text-yellow-400 transition-colors text-sm">Find Jobs</Link></li>
                            <li><Link href="/skills" className="text-slate-400 hover:text-yellow-400 transition-colors text-sm">Skill Assessment</Link></li>
                            <li><Link href="/chat" className="text-slate-400 hover:text-yellow-400 transition-colors text-sm">AI Career Coach</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/contact" className="text-slate-400 hover:text-yellow-400 transition-colors text-sm">Contact</Link></li>
